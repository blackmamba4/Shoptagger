    ...
    <div className="w-full space-y-24 py-12">
      ...
      <div className="flex flex-col items-center gap-8">
        <div className="text-center space-y-4 max-w-3xl mx-auto px-6">
          <h3 className="text-3xl font-bold text-white">Professional Desktop Environment</h3>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 max-w-6xl mx-auto px-6">
        ...
        >
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-zinc-800 bg-zinc-900 aspect-square md:aspect-auto md:h-[600px]">
            <img 
              src={handImg} 
        ...
        <div className="w-full md:w-1/2 space-y-6">
          <h3 className="text-3xl font-bold text-white">Chords in the Palm of Your Hand</h3>
